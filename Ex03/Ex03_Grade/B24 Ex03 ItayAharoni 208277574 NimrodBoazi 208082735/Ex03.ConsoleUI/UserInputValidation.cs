...
namespace Ex03.ConsoleUI
{
    internal class UserInputValidation
    {
        ...
        // $G$ DSN-001 (-15) The UI must not know specific types and their properties concretely! It means that when adding a new type you'll have to change the code here too!
